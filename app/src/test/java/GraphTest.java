...
/*
    ...
    @Test void testAddEdge(){
        Graph graph = new Graph();
        graph.addNode(new GraphNode(new Node(1,1,1)));
        graph.addNode(new GraphNode(new Node(2,2,2)));
        graph.addNode(new GraphNode(new Node(3,3,3)));
    ...
    @Test void testDistFromTo(){
        double methodValue = HelperMethods.distFromTo(new Node(1,1,1), new Node(2,4,5));
